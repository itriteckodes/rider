                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: FadeInImage(image: NetworkImage(request.method.image), placeholder: AssetImage('lib/assets/images/loader.png')),
                          ),
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                request.method.method + ' ' + request.method.number,
                                  style: TextStyle(
                                    color: Clr.silver,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      request.getStatus() + ' ',
                                      style: TextStyle(color: request.status==1?Clr.green:Clr.red, fontSize: Sizer.fontSix(), fontWeight: FontWeight.normal),
                                    ),
                                    Text(
                                      request.date,
                                      style: TextStyle(
